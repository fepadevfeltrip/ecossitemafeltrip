  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-bold text-foreground">Feltrip Concierge</h2>
        <p className="text-muted-foreground">Serviços especializados para sua jornada</p>
      </div>

      <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as any)} className="w-full">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="available">Serviços Disponíveis</TabsTrigger>
          <TabsTrigger value="my-services">Meus Serviços ({myServices.length})</TabsTrigger>
        </TabsList>
      ...
      <Dialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Deseja contratar este serviço?</DialogTitle>
            <DialogDescription>
