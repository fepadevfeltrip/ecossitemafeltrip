          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="rounded-2xl border border-border/50 bg-background p-6 md:p-8 space-y-4">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                {t(
                  "A Cult AI conecta pessoas com lugares através de perfil, mood e contexto cultural — não de listas genéricas. Se o seu espaço tem uma identidade própria, ele provavelmente já encontra as pessoas certas através da nossa plataforma.",
                  "Cult AI connects people with places through profile, mood and cultural context — not generic lists. If your space has its own identity, it probably already finds the right people through our platform."
                )}
              </p>
              <p className="text-muted-foreground text-sm leading-relaxed">
                {t(
                  "Oferecemos uma mentoria aprofundada de comportamento para estabelecimentos que querem entender melhor quem são seus clientes — de forma anônima, ética e contextual. Não é publicidade. É inteligência.",
                  "We offer in-depth behavioral mentoring for establishments that want to better understand who their customers are — anonymously, ethically and contextually. It's not advertising. It's intelligence."
                )}
              </p>
