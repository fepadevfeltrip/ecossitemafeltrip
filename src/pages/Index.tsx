    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-accent/10 flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-5xl space-y-12">
        <div className="text-center space-y-6">
          <FeltripLogo className="mx-auto h-16" />
          <div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <NavigationCard
            icon={Smartphone}
            title="Simular a Experiência do Expatriado"
            subtitle="O App 'Map of Relational Presence' (MRP)"
            onClick={() => setView("expat")}
          />
          <NavigationCard
            icon={LayoutDashboard}
            title="Simular o Painel do Gestor"
            subtitle="Visão de Acompanhamento B2B"
